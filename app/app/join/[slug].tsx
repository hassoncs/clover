	...
	if (isLoading) {
		return (
			<View
				style={{
					flex: 1,
					backgroundColor: activeBrand.theme.colors.background,
					alignItems: "center",
			...
			>
				<ActivityIndicator
					size="large"
					color={activeBrand.theme.colors.primary}
				/>
			</View>
		);
	}
		...
		return (
			...
			>
				...
				<Ionicons
					...
					size={64}
					color={activeBrand.theme.colors.textSecondary}
				/>
				<Text
					style={{
						color: activeBrand.theme.colors.text,
						fontSize: 20,
						fontWeight: "bold",
						marginTop: 16,
						textAlign: "center",
				...
				<Pressable
					...
					style={{
						backgroundColor: activeBrand.theme.colors.surface,
						paddingVertical: 12,
	...
	return (
		...
		>
			...
			>
				...
				>
					You've been invited to join this organization on{" "}
					...
					<View style={{ alignItems: "center" }}>
						...
						>
							<Ionicons
								...
								size={20}
								color={activeBrand.theme.colors.success}
								style={{ marginRight: 8 }}
							/>
							<Text
								style={{
				...
				{joinMutation.error && (
					<Text
						style={{
							color: activeBrand.theme.colors.error,
							fontSize: 14,
							marginTop: 16,
							textAlign: "center",
						}}
