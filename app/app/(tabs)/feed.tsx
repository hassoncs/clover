  ...
  return (
    <View style={{ height: pageHeight }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
            ...
            {likeCount > 0 && (
              <Pressable onPress={() => onLikersPress(game.id)}>
                <Text style={{ color: "#D4D4D8", fontSize: 13, fontWeight: "600" }}>
      ...
      >
        ...
        <Pressable style={{ padding: 4 }} onPress={() => onReportPress(game.id)}>
...
export default function FeedScreen() {
  ...
  const renderItem = useCallback(
    ...
    [currentUserId, pageHeight, bottomPadding, handleCommentPress, handleLikersPress, handleReportPress]
  );
