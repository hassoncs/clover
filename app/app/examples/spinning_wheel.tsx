...
const GAME_DEFINITION: GameDefinition = {
  ...
  templates: {
    wheel: {
      ...
      visual: { type: "circle", radius: WHEEL_RADIUS, color: "#2C3E50" },
      physics: { bodyType: "dynamic", density: 2, angularDamping: 0.3, fixedRotation: false },
      collider: { shape: "circle", radius: WHEEL_RADIUS, friction: 0.3, restitution: 0.1 },
    },
    outerRing: {
      id: "outerRing",
      tags: ["decoration"],
      visual: { type: "circle", radius: WHEEL_RADIUS + 0.2, color: "#D4AF37" },
      type: "zone",
      zone: {
    ...
    anchor: {
      id: "anchor",
      tags: ["anchor"],
      visual: { type: "circle", radius: 0.5, color: "#F1C40F" },
      physics: { bodyType: "static" },
      collider: { shape: "circle", radius: 0.5, friction: 0, restitution: 0 },
    },
    pointer: {
      id: "pointer",
      tags: ["pointer"],
      visual: { type: "polygon", vertices: [{ x: 0, y: -0.9 }, { x: -0.4, y: 0.2 }, { x: 0.4, y: 0.2 }], color: "#F1C40F" },
      physics: { bodyType: "static" },
      collider: { shape: "polygon", vertices: [{ x: 0, y: -0.9 }, { x: -0.4, y: 0.2 }, { x: 0.4, y: 0.2 }], friction: 0, restitution: 0 },
    },
    wheelDivider: {
      id: "wheelDivider",
      tags: ["divider"],
      visual: { type: "rect", width: 0.15, height: WHEEL_RADIUS * 0.95, color: "#FFFFFF" },
      type: "zone",
      zone: {
