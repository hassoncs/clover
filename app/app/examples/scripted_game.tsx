...
export const metadata: ExampleMeta = {
  title: "Scripted Game",
  description: "Test game with JavaScript scripting sandbox. Tap to spawn balls!",
};
...
const createGameDefinition = (script: string): GameDefinition => ({
  ...
  prefabs: {
    ball: {
      ...
      collider: { shape: "circle", radius: 0.4, friction: 0.3, restitution: 0.6 },
    },
    ground: {
      id: "ground",
      tags: ["ground"],
      ...
      collider: { shape: "box", width: 14, height: 1, friction: 0.5, restitution: 0.2 },
    },
    wall: {
      id: "wall",
    ...
    platform: {
      ...
      physics: { bodyType: "static" },
      collider: { shape: "box", width: 4, height: 0.3, friction: 0.5, restitution: 0.3 },
    },
  },
  entities: [
        ...
        <>
          ...
          <View className="bg-black/80 p-3">
            ...
            <Text className="text-yellow-400 font-mono text-xs mb-2">
              Score: {score} | Max Balls: {String(gameDefinition.variables?.maxBalls ?? 10)}
            </Text>
