...
import type { TapTrigger, DragTrigger, TiltTrigger, ButtonTrigger, SwipeTrigger } from '@slopcade/shared';
import type { RuleContext } from '../types';

export class InputTriggerEvaluator implements TriggerEvaluator<TapTrigger | DragTrigger | TiltTrigger | ButtonTrigger | SwipeTrigger> {
