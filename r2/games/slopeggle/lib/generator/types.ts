...
import type {
	LevelDefinition,
	LevelDifficultyParams,
	Seed,
} from "@slopcade/shared/types/LevelDefinition";
 ...
 */
export function isSlopeggleLevelOverlay(
	value: unknown,
): value is SlopeggleLevelOverlay {
