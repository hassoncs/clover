...
try {
  ...
  fs.writeFileSync('/Users/hassoncs/Workspaces/Personal/slopcade/worktree_add4.log', result);
} catch (e) {
  fs.writeFileSync('/Users/hassoncs/Workspaces/Personal/slopcade/worktree_add4.log', e.toString());
}
