...
const GAME_TYPE_KEYWORDS: KeywordMatch[] = [
	...
	{
		keywords: ["angry birds", "knock down", "destroy tower", "hit target"],
		value: "projectile",
		weight: 15,
	},
	{
	...
	{
		keywords: ["mario", "flappy", "doodle jump"],
		value: "platformer",
		weight: 15,
	},
	{
		keywords: ["stack", "pile", "tower", "balance", "build up", "jenga"],
		value: "stacking",
		weight: 10,
	},
	...
	{
		keywords: ["catch", "collect", "falling", "rain", "drop", "basket"],
		value: "falling_objects",
		weight: 10,
	},
	{
		keywords: ["fruit ninja", "catch the"],
		value: "falling_objects",
		weight: 12,
	},
	{
		keywords: ["rope", "swing", "cut", "pendulum", "grapple"],
		value: "rope_physics",
		weight: 10,
	},
	...
	{
		keywords: ["candy crush", "bejeweled", "gem matching", "match three"],
		value: "match3",
		weight: 15,
	},
	{
	...
	{
		keywords: ["tetris clone", "falling tetrominos", "block stacking"],
		value: "tetris",
		weight: 15,
	},
	{
...
const CONTROL_TYPE_KEYWORDS: KeywordMatch[] = [
	...
	{
		keywords: ["drag", "pull", "aim", "sling", "draw"],
		value: "drag_to_aim",
		weight: 10,
	},
	{
		keywords: ["tilt", "accelerometer", "gyro", "lean"],
		value: "tilt_to_move",
		weight: 10,
	},
	{
		keywords: ["swipe", "slide", "move finger"],
		value: "drag_to_move",
		weight: 8,
	},
	{
...
const WIN_CONDITION_KEYWORDS: KeywordMatch[] = [
	...
	{
		keywords: ["destroy", "knock", "eliminate", "clear", "remove all"],
		value: "destroy_all",
		weight: 10,
	},
	{
		keywords: ["survive", "last", "endure", "stay alive"],
		value: "survive_time",
		weight: 10,
	},
	{
		keywords: ["collect all", "gather", "get all"],
		value: "collect_all",
		weight: 10,
	},
	{
		keywords: ["reach", "get to", "arrive", "finish line", "goal"],
		value: "reach_entity",
		weight: 8,
	},
];
...
const LOSE_CONDITION_KEYWORDS: KeywordMatch[] = [
	{
		keywords: ["die", "death", "killed", "destroyed"],
		value: "entity_destroyed",
		weight: 8,
	},
	{
		keywords: ["fall", "drop", "off screen", "out of bounds"],
		value: "entity_exits_screen",
		weight: 8,
	},
	{
		keywords: ["time", "timer", "clock", "seconds"],
		value: "time_up",
		weight: 6,
	},
	{
		keywords: ["lives", "hearts", "health", "no more tries"],
		value: "custom",
		weight: 8,
	},
];
