...
export type TokenType = 'NUMBER' | 'STRING' | 'IDENTIFIER' | 'OPERATOR' | 'LPAREN' | 'RPAREN' | 'COMMA' | 'DOT' | 'QUESTION' | 'COLON' | 'TEMPLATE_START' | 'TEMPLATE_END' | 'TEMPLATE_EXPR_START' | 'TEMPLATE_TEXT' | 'EOF';
...
export type ASTNodeType = 'NumberLiteral' | 'BooleanLiteral' | 'StringLiteral' | 'VectorLiteral' | 'Identifier' | 'MemberAccess' | 'BinaryOp' | 'UnaryOp' | 'Ternary' | 'FunctionCall' | 'TemplateString';
...
export type ASTNode = NumberLiteralNode | BooleanLiteralNode | StringLiteralNode | VectorLiteralNode | IdentifierNode | MemberAccessNode | BinaryOpNode | UnaryOpNode | TernaryNode | FunctionCallNode | TemplateStringNode;
...
export type CustomFunction = (args: ExpressionValueType[], ctx: EvalContext) => ExpressionValueType;
...
export declare function isExpression<T>(value: Value<T>): value is ExpressionValue;
