export function extractPrefabDeps(content: string): string[] {
	const deps: string[] = [];
	try {
...
export function extractEntityDeps(content: string): string[] {
	const deps: string[] = [];
	try {
		const parsed = JSON.parse(content);
...
export function extractEffectGraphDeps(content: string): string[] {
	const deps: string[] = [];
	try {
		const parsed = JSON.parse(content);
...
export function extractDepsForPath(path: string, content: string): string[] {
