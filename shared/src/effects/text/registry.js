import { TEXT_MSDF_UBER_SHADER, TEXT_DROPSHADOW_SHADER, TEXT_OUTER_GLOW_SHADER, TEXT_GRADIENT_SHADER, TEXT_BEVEL_SHADER, TEXT_INNER_GLOW_SHADER, TEXT_OUTLINE_SHADER, } from './shaders';
export const MSDF_TEXT_GENERATOR_SCHEMA = [
    {
        key: 'fontSize',
...
export const TEXT_SHADER_LIBRARY = {
    msdfTextGenerator: {
