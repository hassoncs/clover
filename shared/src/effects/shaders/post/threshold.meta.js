...
export const meta = {
    ...
    aiHints: {
        description: "Converts input into a hard or soft mask using luminance or average RGB with configurable foreground/background colors",
        aliases: ["threshold", "binary", "cutoff", "mask", "key", "matte"],
        category: "utility",
        combinability: ["lookup", "math", "fogOfWar", "pixelateScreen", "halftone"],
    },
};
//# sourceMappingURL=threshold.meta.js.map