...
export const meta = {
    ...
    aiHints: {
        description: "Procedural lightning-column generator using fractal noise displacement and HSV-tinted electric glow",
        aliases: [
...
//# sourceMappingURL=rbLightning.meta.js.map