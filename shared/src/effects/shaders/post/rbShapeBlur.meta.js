...
export const meta = {
    ...
    aiHints: {
        description: "React Bits shape blur generator using SDF round-rect border masking with cursor-driven circular softening",
        aliases: [
...
//# sourceMappingURL=rbShapeBlur.meta.js.map