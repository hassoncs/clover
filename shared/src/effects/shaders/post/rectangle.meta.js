...
export const meta = {
    ...
    aiHints: {
        description: "Procedural rectangle generator with size, rounded corners, softness, center positioning, and foreground/background colors",
        aliases: ["rect", "box", "square", "rounded rectangle"],
        category: "generator",
        combinability: ["lfo", "ramp", "blur", "bloom", "vignette"],
    },
};
//# sourceMappingURL=rectangle.meta.js.map