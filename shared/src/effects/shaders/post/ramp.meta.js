...
export const meta = {
    ...
    aiHints: {
        description: "Procedural gradient generator with horizontal, vertical, radial, and circular ramps plus offset and smoothness control",
        aliases: ["gradient", "ramp", "color ramp"],
        category: "generator",
        combinability: ["level", "colorGrading", "vignette", "blur", "bloom"],
    },
};
//# sourceMappingURL=ramp.meta.js.map