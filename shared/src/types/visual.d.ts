...
export type VisualComponent = RectVisualComponent | CircleVisualComponent | PolygonVisualComponent | ImageVisualComponent | TextVisualComponent;
...
export type VisualComponent3D = PrimitiveVisual3D | VoxelVisual3D | ModelVisual3D | Sprite3DVisual;
export {};
