...
import type { Camera3DConfig, EntityPrefab3D, GameEntity3D, InputConfig3D, World3DConfig } from "./types3d";
/**
...
export type GameVariableValue = number | boolean | string | Vec2 | Vec3 | Value<ExpressionValueType>;
/**
 ...
 */
export declare function isVariableWithTuning(v: GameVariable): v is VariableWithTuning;
/**
 * Check if a variable has tuning metadata
 */
export declare function isTunable(v: GameVariable): boolean;
/**
 * Get the actual value from a GameVariable (handles both formats)
 */
export declare function getValue(v: GameVariable): GameVariableValue;
/**
 * Get label for a variable (auto-generates from key if not provided)
 */
export declare function getLabel(key: string, v: GameVariable): string;
export declare function inferKnob(variable: VariableWithTuning): KnobConfig | undefined;
...
export declare const DEFAULT_WORLD_CONFIG: WorldConfig;
