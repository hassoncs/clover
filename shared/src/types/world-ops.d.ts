import type { Bounds, Vec2, Vec3 } from "./common";
...
export interface WorldRaycastHit3D {
    entityId: string;
    point: Vec3;
    normal: Vec3;
    distance: number;
...
export type EasingFunction = "linear" | "ease-in" | "ease-out" | "ease-in-out" | "ease-in-quad" | "ease-out-quad" | "ease-in-out-quad";
...
//# sourceMappingURL=world-ops.d.ts.map