...
import type { EntityTarget } from "./targeting";
...
export type ContainerConfig = StackContainerConfig | GridContainerConfig | SlotContainerConfig;
...
export type ContainerInstance = StackContainerInstance | GridContainerInstance | SlotContainerInstance;
/**
...
export type ContainerAction = ContainerPushAction | ContainerPopAction | ContainerTransferAction | ContainerSwapAction | ContainerClearAction | ContainerSelectAction | ContainerDeselectAction;
...
export type ContainerCondition = ContainerIsEmptyCondition | ContainerIsFullCondition | ContainerCountCondition | ContainerHasItemCondition | ContainerCanAcceptCondition | ContainerTopItemCondition | ContainerIsOccupiedCondition;
