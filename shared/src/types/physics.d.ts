...
export type ColliderComponent = BoxColliderComponent | CircleColliderComponent | PolygonColliderComponent | CapsuleColliderComponent;
...
export type ColliderComponent3D = BoxCollider3D | SphereCollider3D | CapsuleCollider3D | CylinderCollider3D;
