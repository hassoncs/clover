import { z } from "zod";
import { GameVariablesSchema, } from "../expressions/schema-helpers";
...
export const ChildEntityDefinitionSchema = z.lazy(() => z.object({
...
export const ChildPrefabDefinitionSchema = z.lazy(() => z.object({
    name: z.string(),
    prefab: z.string(),
    localTransform: TransformComponentSchema,
    slot: z.string().optional(),
