...
export type PartyInputType = "text" | "choice" | "drawing" | "buzzer" | "mic" | "investment" | "matching" | "wheel";
...
export type PartyMessage = StateUpdateMessage | PlayerJoinedMessage | PlayerLeftMessage | InputRequestMessage | InputResponseMessage | PhaseChangeMessage | ErrorMessage | HostReconnectMessage | PlayerReconnectMessage | StartGameMessage | PrivateStateMessage | PlayerTokenMessage;
