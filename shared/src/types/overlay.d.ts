...
export type OverlayElementType = 'text' | 'bar' | 'counter' | 'button' | 'image' | 'container' | 'spacer';
export type OverlayElement = TextOverlayElement | BarOverlayElement | CounterOverlayElement | ButtonOverlayElement | ImageOverlayElement | ContainerOverlayElement | SpacerOverlayElement;
