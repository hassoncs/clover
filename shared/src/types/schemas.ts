...
export const MovementDirectionSchema = z.discriminatedUnion("type", [
	...
	z.object({
		type: z.literal("toward_target"),
		targetTag: z.string().optional(),
	}),
	z.object({
		type: z.literal("away_from_target"),
		targetTag: z.string().optional(),
	}),
...
export const TapTriggerSchema = z.object({
	type: z.literal("tap"),
	target: z
		.union([z.literal("screen"), z.literal("self"), z.string()])
		.optional(),
...
export const TiltTriggerSchema = z.object({
	...
	direction: z.enum(["positive", "negative", "any"]).optional(),
});
...
export const ApplyForceActionSchema = z.object({
	...
	y: NumberValueSchema.optional(),
	direction: z
		.enum(["drag_direction", "tilt_direction", "toward_touch"])
		.optional(),
	force: NumberValueSchema.optional(),
});
...
export const ComboIncrementActionSchema = z
	.object({
		type: z.literal("combo_increment"),
	})
	.passthrough();

export const ComboResetActionSchema = z
	.object({
		type: z.literal("combo_reset"),
	})
	.passthrough();

export const ActivateCheckpointActionSchema = z
	.object({
		type: z.literal("activate_checkpoint"),
	})
	.passthrough();

export const SaveCheckpointActionSchema = z
	.object({
		type: z.literal("save_checkpoint"),
	})
	.passthrough();

export const RestoreCheckpointActionSchema = z
	.object({
		type: z.literal("restore_checkpoint"),
	})
	.passthrough();

export const GridMoveActionSchema = z
	.object({
		type: z.literal("grid_move"),
	})
	.passthrough();

export const GridPlaceActionSchema = z
	.object({
		type: z.literal("grid_place"),
	})
	.passthrough();

export const InventoryAddActionSchema = z
	.object({
		type: z.literal("inventory_add"),
	})
	.passthrough();

export const InventoryRemoveActionSchema = z
	.object({
		type: z.literal("inventory_remove"),
	})
	.passthrough();

export const ResourceModifyActionSchema = z
	.object({
		type: z.literal("resource_modify"),
	})
	.passthrough();

export const AddXPActionSchema = z
	.object({
...
export const WavesStartActionSchema = z
	.object({
		type: z.literal("waves_start"),
	})
	.passthrough();

export const WavesNextActionSchema = z
	.object({
		type: z.literal("waves_next"),
	})
	.passthrough();

export const PathStartActionSchema = z
	.object({
		type: z.literal("path_start"),
	})
	.passthrough();

export const PathStopActionSchema = z
	.object({
		type: z.literal("path_stop"),
	})
	.passthrough();

export const TargetNearestActionSchema = z
	.object({
...
export const ContainerPopActionSchema = z.object({
	...
	container: z.string(),
	position: z
		.union([z.literal("top"), z.literal("selected"), z.number()])
		.optional(),
	storeAs: z.string().optional(),
