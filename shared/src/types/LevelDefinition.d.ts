 ...
 */
export declare function isLevelDefinition(value: unknown): value is LevelDefinition;
/**
 * Generate the full level identity string: `${packId}:${levelId}`.
 */
export declare function getLevelIdentity(level: LevelDefinition): string;
/**
 * Validate that a level identity is unique within a set of levels.
 */
export declare function validateLevelUniqueness(levels: LevelDefinition[]): {
    valid: boolean;
    duplicateIds: string[];
};
/**
 ...
 */
export declare const CURRENT_LEVEL_SCHEMA_VERSION = 1;
/**
 * Minimum compatible schema version for parsing.
 * Levels with schemaVersion < this require migration.
 */
export declare const MIN_COMPATIBLE_SCHEMA_VERSION = 1;
//# sourceMappingURL=LevelDefinition.d.ts.map