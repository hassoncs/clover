...
import type { EntityTarget } from "../../types/targeting";
...
export type GridAction = GridPlaceAction | GridMoveAction | GridSwapAction | GridClearAction | GridFillAction | GridSetCellDataAction;
