  ...
  return {
    ...
    prefabs: {
      ball: {
        id: 'ball',
        tags: ['ball'],
        visual: { type: 'circle', radius: 0.15, color: '#FF6B6B' },
        physics: { bodyType: 'dynamic', density: 1 },
        collider: { shape: 'circle', radius: 0.15, friction: 0.05, restitution: 0.75 },
      },
      bluePeg: {
        id: 'bluePeg',
        tags: ['peg', 'blue-peg'],
        visual: { type: 'circle', radius: 0.125, color: '#4ECDC4' },
        physics: { bodyType: 'static' },
        collider: { shape: 'circle', radius: 0.125, friction: 0.05, restitution: 0.85 },
      },
      orangePeg: {
        id: 'orangePeg',
        tags: ['peg', 'orange-peg'],
        visual: { type: 'circle', radius: 0.125, color: '#F97316' },
        physics: { bodyType: 'static' },
        collider: { shape: 'circle', radius: 0.125, friction: 0.05, restitution: 0.85 },
      },
    },
