  ...
  if (error || !theme) {
    return (
      <SafeAreaView className="flex-1 bg-gray-900 items-center justify-center p-6">
        <Text className="text-red-400 text-center text-lg">{error ?? "Theme not found"}</Text>
      ...
      <ScrollView className="flex-1">
        ...
        <View className="px-4 pt-4 pb-8">
          ...
          <View className="flex-row gap-2 mb-6">
            <View className={`px-3 py-1 rounded-full ${theme.isPublic ? 'bg-green-900/30' : 'bg-gray-700'}`}>
              <Text className={`${theme.isPublic ? 'text-green-300' : 'text-gray-300'} text-sm`}>
          ...
          <View className="mb-8">
            <Text className="text-white text-xl font-bold mb-3">Prompt Modifier</Text>
            ...
            >
              {isDeleting ? (
                <View className="flex-row items-center">
                  ...
                  <Text className="text-white font-bold text-base ml-2">Deleting...</Text>
                </View>
              ) : (
