              ...
              >
                {pack.popular && (
                  <View className="absolute -top-2 left-1/2 -ml-12 bg-theme-primary px-3 py-1 rounded-full">
                    <Text className="text-theme-text-inverse text-xs font-bold">POPULAR</Text>
                  </View>
                )}
                ...
                <View className="flex-row items-center justify-between">
                  <View className="flex-1">
                    ...
                    <View className="flex-row items-baseline mt-1">
                      <Text className="text-theme-primary font-bold text-2xl">{pack.gems}</Text>
                      <Text className="text-theme-text-secondary ml-1">gems</Text>
                      {pack.bonus && (
                        <View className="bg-theme-success/20 px-2 py-0.5 rounded-full ml-2">
                          <Text className="text-theme-success text-xs font-bold">{pack.bonus}</Text>
                        </View>
                      )}
                    </View>
                  </View>
