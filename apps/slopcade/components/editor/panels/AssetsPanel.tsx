...
const BASIC_SHAPES = [
	{
		...
		icon: "⬜",
		label: "Box",
		physicsShape: "box" as const,
		spriteType: "rect" as const,
	},
	{
		id: "circle",
		icon: "⚪",
		label: "Circle",
		physicsShape: "circle" as const,
		spriteType: "circle" as const,
	},
	{
		id: "triangle",
		icon: "🔺",
		...
		spriteType: "polygon" as const,
	},
];

export function AssetsPanel() {
	const { document, addEntity, addEntityFromPrefab, setSheetSnapPoint } =
		useEditor();
	...
	const handleAddFromTemplate = (prefabId: string) => {
		const centerX = 10;
		const centerY = 6;
		addEntityFromPrefab(prefabId, centerX, centerY);
		setSheetSnapPoint(0);
	};
							...
							>
								<View style={styles.assetIcon}>
									<Text style={styles.assetIconText}>
										{asset.prefab.collider?.shape === "circle" ? "⚪" : "⬜"}
									</Text>
								</View>
