...
export function CommentItem({
	...
	const replies = trpc.social.listComments.useQuery(
	...
	const depthPadding =
		comment.depth > 0 ? `ml-${Math.min(comment.depth * 8, 16)}` : "";
				...
				<View className="flex-row">
					...
					<View className="flex-1">
						<View className="flex-row items-center mb-1">
							...
							{comment.isEdited && (
								<Text className="text-theme-text-tertiary text-xs ml-1">
									(edited)
								</Text>
							)}
						</View>
						...
						<View className="flex-row items-center mt-2 gap-4">
							<Pressable
								...
								accessibilityLabel={
									comment.userReacted ? "Unlike comment" : "Like comment"
								}
							...
							{comment.depth < 2 && (
								...
								>
									...
									/>
									<Text className="text-theme-text-secondary text-xs ml-1">
										Reply
									</Text>
								</Pressable>
							)}
