...
import { MicButton } from "@slopcade/ui";
import React, {
	useCallback,
	useEffect,
	useMemo,
...
export function ChatTextArea({
	...
	const volumeLevel = speechToText?.volumeLevel ?? 0;
	const isRecording = speechToText?.isRecording ?? false;
	const isConnecting = speechToText?.isConnecting ?? false;
	const error = speechToText?.error ?? null;
	const startRecording = speechToText?.startRecording;
