...
declare global {
	interface Window {
		GodotBridge?: {
			...
			raycast3D(fromX: number, fromY: number, fromZ: number, toX: number, toY: number, toZ: number): void;
			...
			createVoxelBatch(voxelsJson: string): void;
