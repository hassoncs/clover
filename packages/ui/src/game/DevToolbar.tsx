...
export function DevToolbar({ devTools }: DevToolbarProps) {
	...
	const bridge =
		(typeof window !== "undefined" && (window as any).SlopcadeDebugBridge) ||
		null;
	...
	return (
		<View
			style={[styles.container, state.isExpanded && styles.containerExpanded]}
			...
			{state.isExpanded && (
				<View style={styles.content}>
						...
						<View style={styles.section}>
							...
							<View style={styles.buttonRow}>
								<Pressable
									style={[
										styles.stepButton,
										isStepping && styles.stepButtonDisabled,
									]}
					...
					<Pressable
						...
						onPress={toggleInputDebug}
						accessibilityRole="button"
						accessibilityLabel="Toggle input debug"
						accessibilityState={{ selected: state.showInputDebug }}
					>
					...
					<Pressable
						style={styles.toggleRow}
						onPress={togglePhysicsShapes}
						accessibilityRole="button"
						accessibilityLabel="Toggle physics shapes"
						accessibilityState={{ selected: state.showPhysicsShapes }}
					>
					...
					<Pressable
						...
						accessibilityState={{ selected: state.showZones }}
					>
					...
					<Pressable
						...
						onPress={toggleFPS}
						accessibilityRole="button"
						accessibilityLabel="Toggle FPS display"
						accessibilityState={{ selected: state.showFPS }}
					>
