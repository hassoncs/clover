...
interface SplashPreviewCanvasProps {
...
function SplashPreviewCanvas({
	...
	const bgColors: Record<SplashStyleName, string[]> = {
	...
	const colors = bgColors[styleName];
	...
	const renderers: Record<SplashStyleName, () => JSX.Element> = {
