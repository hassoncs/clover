...
export function PenCanvasPanel({
  ...
  const onMouseDown = useCallback(
    ...
    [cameraMouseDown, hitTestNodePath, penMouseDown, updateSelection]
  );
  ...
  const onMouseMove = useCallback(
    ...
    [cameraMouseMove, hitTestNodePath, penMouseMove]
  );
  ...
  const onMouseUp = useCallback(
    ...
    [cameraMouseUp, penMouseUp, selectableLayoutNodes, updateSelection]
  );
      ...
      {!hideHeader && (
        ...
        <View style={styles.headerRight}>
          ...
          {totalFrames > 0 && (
            <View style={[styles.navControls, { backgroundColor: c.surface }]}>
              <Pressable
                onPress={() => setSelectedFrameIndex((i) => Math.max(0, i - 1))}
          ...
          <View style={styles.canvasArea}>
            ...
            >
              <PenRenderer
                ...
                hoveredNodePath={hoveredNodePath ?? undefined}
