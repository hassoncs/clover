...
export function PropertiesPanel() {
	...
	const displayName =
		selectedEntity.name || selectedEntity.prefab || selectedEntity.id;
		...
		<View style={styles.container}>
			<View style={styles.header}>
				<View style={styles.headerText}>
					...
					{collider && <Text style={styles.entityType}>{collider.shape}</Text>}
				</View>
			...
			<View style={styles.section}>
				...
				<PropertySlider
					...
					unit="°"
					onChange={(deg) =>
						rotateEntity(selectedEntityId, deg * (Math.PI / 180))
					}
				/>
			</View>
			...
			{(physics || collider) && (
				<View style={styles.section}>
					...
					<PropertySegment
						...
						onChange={(value) =>
							handlePhysicsChange("bodyType", value as PhysicsBodyType)
						}
					/>
