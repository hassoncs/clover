...
try {
  ...
  fs.writeFileSync('/Users/hassoncs/Workspaces/Personal/slopcade/worktree_add5.log', result);
} catch (e) {
  fs.writeFileSync('/Users/hassoncs/Workspaces/Personal/slopcade/worktree_add5.log', e.toString());
}
